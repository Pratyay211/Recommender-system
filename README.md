...
```
You must have Python 3.6+ installed in your system.
...
```
git clone https://github.com/Pratyay211/Recommender-system.git
```
...
This project is extended with rich modules.
